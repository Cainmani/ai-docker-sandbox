...
|---------|------|------------------|
| v1.5.2 | 2026-07 | None — auto-update now reads releases from a public repo so it works without a GitHub login (download 1.5.2 by hand once; later updates are automatic) |
